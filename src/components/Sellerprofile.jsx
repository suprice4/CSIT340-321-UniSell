...
const INITIAL_PROFILE = {
  ...
  address:   "123 Commerce Street, Cebu City",
  bio:       "Multi-platform seller managing stores across Shopee, Lazada, and TikTok Shop.",
...
export default function SellerProfile() {
  ...
  const validateProfile = () => {
    const errors = {};
    if (!editProfile.firstName) errors.firstName = "First name is required.";
    if (!editProfile.lastName)  errors.lastName  = "Last name is required.";
  ...
  const handleSavePassword = () => {
    ...
    setToast({ msg: "Password changed successfully!" });
  };
              ...
              <>
                <div style={s.grid2}>
                  <div style={s.formGroup}>
                    ...
                    <input style={s.input(!!profileErrors.firstName)} value={editProfile.firstName} onChange={(e) => setEditProfile({ ...editProfile, firstName: e.target.value })} placeholder="First name" />
                    {profileErrors.firstName && <p style={s.errorText}>{profileErrors.firstName}</p>}
                  </div>
                  <div style={s.formGroup}>
                    <label style={s.label}>Last Name</label>
                    <input style={s.input(!!profileErrors.lastName)} value={editProfile.lastName} onChange={(e) => setEditProfile({ ...editProfile, lastName: e.target.value })} placeholder="Last name" />
                    {profileErrors.lastName && <p style={s.errorText}>{profileErrors.lastName}</p>}
                  </div>
                </div>
                <div style={s.grid2}>
                  <div style={s.formGroup}>
          ...
          <div style={s.card}>
            ...
            <div style={s.btnRow}>
              <button style={s.saveBtn} onClick={() => {
                ...
                setToast({ msg: "Platform settings saved!" });
              }}>
