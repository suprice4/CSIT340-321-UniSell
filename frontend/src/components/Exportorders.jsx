...
export default function ExportOrders() {
  ...
  const handleExport = () => {
    ...
    const rows = toExport.map((o) => [
      `#${o.id}`, o.customer, o.platform, o.product, o.amount, o.status, o.date
    ]);
  ...
  return (
    <div style={s.page}>
      ...
      <div style={s.main}>
        ...
        <p style={s.pageSub}>Filter, select, and download your orders as a spreadsheet file. <button onClick={() => navigate("/orders")} className="exportorders-text-link">← Back to Orders</button></p>
        ...
        <div style={s.card}>
          ...
          <div style={s.summaryBar}>
            ...
            {selectedIds.length > 0 && (
              <button onClick={() => setSelectedIds([])} className="exportorders-clear-link">
                Clear Selection
              </button>
            )}
          </div>
